...
var Runner = function (game, x, y, dir){
 ...
 // this.body.velocity.x = -300 + Math.random()*50;
...
Runner.prototype.launch = function(){
  ...
  this.renderable = true;
 // this.body.acceleration.x = -20 * this.dir;
}
...
UpAndDown.prototype.update = function() {
  ...
  if (!this.asleep){ 
    ...
    // 
    // 
    //this.y = 300 + Math.sin((game.time.now+this.offset)/1000) * 300
  ...
  //  this.body.velocity.y = Math.sin((game.time.now)/1000) * 300
  }
}
...
Bouncer.prototype.update = function() {
  ...
  if (!this.asleep){ 
    if (game.time.time - this.markTime >= this.freq){
      ...
      this.markTime = game.time.time;
     // this.body.bounce.y = 0.8 + Math.random()*0.4;
    }
...
var Seeker = function (game, x, y, target, baseVelocity, img) {
  ...
  // var randImage = Math.floor(Math.random()*2);
  // if (randImage == 0) {
  //   this.img = 'seek-enemy-pink';
  // } else {
  //   this.img = 'seek-enemy'
  // }
  // this.img = 'seek-enemy-pink';
